  ...
  const handleSave = async (publish: boolean) => {
    ...
    try {
      ...
      await setDoc(doc(db, "projects", projectId), {
        ...
        projectType,
        projectSubtype,
        title: { en: title, "en-US": title, "en-GB": title, nl: "" },
        description: { en: description, "en-US": description, "en-GB": description, nl: "" },
        projectOverview: { en: projectOverview, "en-US": projectOverview, "en-GB": projectOverview, nl: "" },
        rooms: fieldValues.rooms,
        squareMeters: fieldValues.squareMeters,
        scheduledCompletion: fieldValues.scheduledCompletion,
        location: fieldValues.location,
        milestones: milestones.map((m) => ({ en: m.text, "en-US": m.text, "en-GB": m.text, nl: "" })),
        mainPicture,
        gallery,
        phases,
        published: publish,
